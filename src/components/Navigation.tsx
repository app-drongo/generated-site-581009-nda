...
// Generated: 2025-08-21T08:05:59.736Z
// Section: navigation
// Category: navigation
...
import { Menu, X, ArrowRight, BarChart, FileText, CreditCard, PieChart } from "lucide-react"
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              <div className="size-8 rounded-lg bg-gradient-to-br from-blue-600 to-blue-400 flex items-center justify-center">
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 border-t">
            ...
            <div className="pt-4 flex flex-col space-y-2">
              ...
              <Button className="justify-start group bg-blue-600 hover:bg-blue-700">
                Start Free Trial
                <ArrowRight className="ml-2 size-4 transition-transform group-hover:translate-x-1" />
              </Button>
            </div>
