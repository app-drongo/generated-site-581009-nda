...
// Generated: 2025-08-21T08:06:00.941Z
// Section: cta
// Category: cta
...
import { ArrowRight, Sparkles, Users, Zap, Shield, Calculator, FileText, BarChart } from "lucide-react"

export default function CTA() {
  const stats = [
    { value: "10K+", label: "Consulting Firms", icon: Users },
    { value: "99.9%", label: "Uptime", icon: Shield },
    { value: "$2B+", label: "Invoices Processed", icon: FileText },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of consulting firms who have transformed their invoicing and accounting with FinanceFlow.
              ...
              <div className="text-center mb-12">
                ...
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                  ...
                  {["Deloitte", "KPMG", "McKinsey", "BCG", "Accenture"].map((company, i) => (
                    <div 
                      key={i} 
